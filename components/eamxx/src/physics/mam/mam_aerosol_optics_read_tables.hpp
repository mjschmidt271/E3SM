...
inline Field make_field(const std::string &name, const FieldLayout &layout,
...
inline void read_rrtmg_table(const std::string &table_filename, const int imode,
  ...
  auto refindex_real_sw_host =
      aerosol_optics_fields.at("refindex_real_sw").get_view<const Real **, Host>();
  auto refindex_im_sw_host =
      aerosol_optics_fields.at("refindex_im_sw").get_view<const Real **, Host>();
  auto refindex_real_lw_host =
      aerosol_optics_fields.at("refindex_real_lw").get_view<const Real **, Host>();
  auto refindex_im_lw_host =
      aerosol_optics_fields.at("refindex_im_lw").get_view<const Real **, Host>();
...
inline void read_water_refindex(const std::string &table_filename,
  ...
  auto refindex_real_water_sw =
      make_field("refindex_real_water_sw", refindex_water_sw_layout, grid);
  auto refindex_im_water_lw = make_field("refindex_im_water_lw", refindex_water_lw_layout, grid);
  auto refindex_real_water_lw =
      make_field("refindex_real_water_lw", refindex_water_lw_layout, grid);

  std::vector<Field> fields = {refindex_im_water_sw, refindex_real_water_sw, refindex_im_water_lw,
...
inline void
set_refindex_aerosol(const int species_id, std::map<std::string, Field> fields,
